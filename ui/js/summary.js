...
$('.modal').modal();
 ...
 //    method: 'post'
	...
	// 	contractInstance.totalVotesFor('Gandhi', {from: web3.eth.accounts[0]}, function() {
	...
	// 	contractInstance.totalVotesFor('Pawar', {from: web3.eth.accounts[0]}, function() {
	...
	// 	contractInstance.totalVotesFor('Banerjee', {from: web3.eth.accounts[0]}, function() {
